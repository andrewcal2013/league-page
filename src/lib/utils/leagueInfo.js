...
export const leagueName = "The_Motley_Crew"; // your league name
...
export const homepageText = `
  <p>Founded in 2020, the league launched as a dynasty league. Each year, the managers compete to win the Crew Cup and avoid the ever-humiliating Toliet Bowl.</p>
